...
export class CreateReputation1583279033786 implements MigrationInterface {
  name = 'CreateReputation1583279033786';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      'CREATE TABLE "reputation" ("id" SERIAL NOT NULL, "value" integer NOT NULL DEFAULT 1, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, "deleted_at" TIMESTAMP, "user_id" bigint, "chat_id" bigint, "message_id" bigint, CONSTRAINT "REL_0ca5aaff74c6eadcf6cc0fdf9f" UNIQUE ("chat_id"), CONSTRAINT "REL_dab63482eb4a70947e0bf27ef8" UNIQUE ("message_id"), CONSTRAINT "PK_640807583e8622e1d9bbe6f1b7b" PRIMARY KEY ("id"))',
      undefined,
    );
    await queryRunner.query(
